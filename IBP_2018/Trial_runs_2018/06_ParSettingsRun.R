...
TUR.ctrl@f.vars["catch unique",]            <- c(0,0,1,1,1,2,2,2,2)
TUR.ctrl@logN.vars[]                        <- c(0,rep(1,8))
TUR.ctrl@obs.vars["catch unique",]          <- c(0,1,1,1,2,3,4,5,5)     + 101
...
TUR.ctrl@cor.obs[]                          <- NA
#TUR.ctrl@cor.obs["BTS-ISIS",1:6]           <- c(0,1,2,2,2,2)
#TUR.ctrl@cor.obs["SNS",1:5]                <- c(0,1,2,2,2)
